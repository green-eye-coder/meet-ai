              ...
              <div className="prose prose-sm max-w-none">
                <Markdown
                  components={{
                    ...
                    h4: (props) => (
                      <h4 className="text-base font-semibold mt-6" {...props} />
                    ),
                    p: (props) => (
                      <p className="mb-6 leading-relaxed" {...props} />
                    ),
                    ul: (props) => (
                      <ul className="list-dics list-inline leading-relaxed" {...props} />
                    ),
                    ol: (props) => (
                        <ol className="list-decimal list-inline leading-relaxed" {...props} />    
                    ),
                    li: (props) => (
                    ...
                    blockquote: (props) => (
                        <blockquote className="border-l-4 border-gray-300 pl-4 italic text-gray-600 mb-6" {...props} />
                    )
